...
class CarCategoryController {
    async createCarCategory(req, res) {
        try {
            ...
            res.status(500).json({ message: 'Error creating car category', error: error.message });
        }
    }
    ...
    async getAllCarCategory(req, res) {
        try {
            ...
            res.status(500).json({ message: 'Error fetching car categories', error: error.message });
        }
    }
    ...
    async getCarCategoryById(req, res) {
        try {
            ...
            res.status(500).json({ message: 'Error fetching car category', error: error.message });
        }
    }
}
